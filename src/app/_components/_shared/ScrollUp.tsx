...
const ScrollUp: React.FC = () => {
  ...
  return (
    <span className={`fixed bottom-[61px] right-0 z-40 flex cursor-pointer items-center justify-center border-solid py-2 pb-1 transition-all duration-300 ease-out ${showButton ? 'right-[25px]' : 'translate-x-full'} flex flex-col`} onClick={scrollToTop}>
