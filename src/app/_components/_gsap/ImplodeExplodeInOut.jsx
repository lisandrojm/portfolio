...
export default function ImplodeExplodeInOut({ children, durationIn = 1, durationOut = 0.5, delay = 0, delayOut = 0, ease = 'power4.out', easeOut = 'power4.in', target, skipOutro, watch = false, start = 'top bottom', end = 'bottom top', scrub = false, markers }) {
